...
public class BuildingsTest{
    ...
    public void TowerRadiusTrue() {
        ...
        d.spawnBuilding(CardType.TOWER_CARD,2,3);
    ...
    public void TowerRadiusFalse() {
        ...
        d.setHerosCastle(hc);
        d.setCharacter(testCharacter);
        d.spawnBuilding(CardType.ZOMBIEPIT_CARD, 1, 2);
        d.spawnBuilding(CardType.TOWER_CARD,12,2);
    ...
    public void TestTrap(){
        ...
        Spawner spawnB = (Spawner) d.spawnBuilding(CardType.VAMPIRECASTLE_CARD, 2, 1);
        spawnB.addSpawningTile(orderedPath);
